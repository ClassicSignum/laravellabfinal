          ...
          <ul class="navbar-nav m-auto">
            ...
            <li class="dhover1 nav-item dropdown pr-4 pb-0">
              ...
              <div class="dropdown-menu bg-dark dmenu1" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="">PRIVATE CARS</a>
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="/images/travelia/car-1.jpg" class="d-block w-100 wow heartBeat" data-wow-duration="10s"
              data-wow-iteration="90" alt="...">
            <div class="carousel-caption d-none d-md-block">
              <h5>Microbus</h5>
              <br>
              <p>Suitable and air conditioned</p>
            </div>
          </div>
          <div class="carousel-item">
            <img src="/images/travelia/car-2.jpg" class="d-block w-100 wow pulse" data-wow-duration="3s"
              data-wow-iteration="90" alt="...">
            <div class="carousel-caption d-none d-md-block">
              <h5>Private car</h5>
              <br>
              <p>Luxarious auto-mobile for you</p>
            </div>
          </div>
          <div class="carousel-item">
            <img src="/images/travelia/car-3.jpg" class="d-block w-100 wow heartBeat" data-wow-duration="8s"
              data-wow-iteration="90" alt="...">
            <div class="carousel-caption d-none d-md-block">
              <h5>Pick up van</h5>
              <br>
              <p>What you wanna pick!</p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row ">
          <div class="col-md-3">
            <div class="place text-center">
              <figure class="wow slideInLeft">
                ...
                <img src="/images/travelia/1.jpg" alt="">
                <h3>Mordan metalic</h3>
              </figure>
            </div>
          </div>
          <div class="col-md-3">
            <div class="project wow slideInUp">
              <div class="project__card">
                <a href="" class="project__image"><img src="/images/travelia/2.jpg" width=600 height=400
                    alt=""></a>
                <div class="project__detail">
                  <h2 class="project__title"><a href="#">Red car</a></h2>
                  <small class="project__category"><a href="#">remarkable </a></small>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-3">
            ...
            <div class="project wow slideInUp">
              <div class="project__card">
                <a href="" class="project__image"><img src="/images/travelia/3.jpg" width=600 height=400
                    alt=""></a>
                <div class="project__detail">
                  <h2 class="project__title"><a href="#">Silver Sports Car</a></h2>
                  <small class="project__category"><a href="#">a lovely</a></small>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-3">
            ...
            <div class="project wow slideInUp">
              <div class="project__card">
                <a href="" class="project__image"><img src="/images/travelia/4.jpg" width=600 height=400
                    alt=""></a>
                <div class="project__detail">
                  <h2 class="project__title"><a href="#">Renault Clio</a></h2>
                  <small class="project__category"><a href="#">beautiful red</a></small>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="project">
              <div class="project__card">
                <a href="" class="project__image"><img src="/images/travelia/5.jpg" width=600 height=400 alt=""></a>
                <div class="project__detail">
                  <h2 class="project__title"><a href="#">BMW 3 Series</a></h2>
          ...
          <div class="col-md-3">
            ...
            <div class="project">
              <div class="project__card">
                <a href="" class="project__image"><img src="/images/travelia/6.jpg" width=600 height=400 alt=""></a>
                <div class="project__detail">
                  <h2 class="project__title"><a href="#">Audi a6</a></h2>
                  <small class="project__category"><a href="#">a lovely car</a></small>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-3">
            ...
            <div class="project">
              <div class="project__card">
                <a href="" class="project__image"><img src="/images/travelia/7.jpg" width=600 height=400 alt=""></a>
                <div class="project__detail">
                  <h2 class="project__title"><a href="#">Audi Q7</a></h2>
                  <small class="project__category"><a href="#">crystal clear</a></small>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-3">
            <div class="place text-center">
              <figure class="wow lightSpeedIn">
                ...
                <img src="/images/travelia/8.jpg" alt="">
                <h3>Piranha - Octopus</h3>
              </figure>
            </div>
          </div>
        </div>
        ...
        <div class="modal-body">
          <form class="form" action="/login" method="POST">
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-lg" name="email" id="loginemail" required="">
