...
<body>
                    ...
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="dhover2 nav-item dropdown pr-4 pb-0">
                            ...
                            <div class="dropdown-menu bg-dark dmenu2" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="">My rent history</a>
    ...
    <section>
        ...
        <div class="container text-center">
            ...
            <img src="/images/vehicles/{{ $result->cartitle }}.jpg" alt="">
            <h4>This is : {{ $result->cartitle }}</h4>
            <br>
            <h4>Per day rent is : {{ $result->cost }}</h4>
            <br>
            <form action="" class="mt-4 mb-5" method="post">
                <label for="rentday">Rent for day:</label>

                <select name="rentday" id="">
                ...
                <input type="submit" name="submit" value="next-->" class="btn btn-outline-success mt-2">
            </form>
