...
<body>
  ...
  <section class="blog-part text-center">
    ...
    <form action="" method="post">     
        ...
        <textarea name="blog" cols="70" rows="10"></textarea>
        <br>
        <input type="submit" value="submit" name="submit" class="btn btn-outline-secondary mb-3">
        <br>
                    ...
                    @foreach($result as $result)
                        ...
                        <div class="col-md-2">
                            {{ $result->usermail }}
                                    ...
                                    <input type="hidden" name="usermail" value="{{ $result->usermail }}">
                                    <input type="submit" value="delete this" class="btn btn-outline-danger mb-2">
