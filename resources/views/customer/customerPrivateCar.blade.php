      ...
      <div class="row">
        <?php
          ...
          @foreach($car as $car)
            <?php $count++ ?>
        <div class="col-md-6">
          <img src="/images/vehicles/{{ $car->cartitle }}.jpg" alt="">
          <div class="item text-center">
            ...
            <form action="" method="post">
              <input type="hidden" name="cartitle" value="{{ $car->cartitle }}">
              <input type="hidden" name="carcost" value="{{ $car->cost }}">
              <input type="submit" name="submit" value="go for it" class="btn btn-success mt-2 mb-3">
            </form>
