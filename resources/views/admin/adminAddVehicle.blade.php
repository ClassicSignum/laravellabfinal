                ...
                <div class="col-md-10">
                    <div class="items2">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="text" name="cartitle" class="form-control input-sm"
                            ...
                            <div class="form-group">
                                <input type="number" name="carcost"  class="form-control input-sm"
                                    placeholder="car rent cost">
                           ...
                           <br>                          
                            ...
                            <input type="submit" name="submit" value="Confirm" class="btn btn-info btn-block submit">
